...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.no/fhir/ig/ImplementationGuide/hl7.fhir.no.basis | *Version*:2.2.4-test |
| Active as of 2025-12-15 | *Computable Name*:NoBasis |
...
```json
{
  ...
  "name" : "NoBasis",
  "status" : "active",
  "date" : "2025-12-15T09:21:49+00:00",
  "jurisdiction" : [
    {
      "coding" : [
        {
  ...
  "definition" : {
    ...
    "resource" : [
      ...
      },
      {
        ...
        "reference" : {
          "reference" : "Patient/Pasient-Middle-Name-1"
        },
        "name" : "Pasient-Middle-Name-1",
        "description" : "Eksempel på pasient med navn (inkl. mellomnavn) og fødselsnummer",
        "exampleCanonical" : "http://hl7.no/fhir/ig/StructureDefinition/no-basis-Patient"
      },
      {
        "extension" : [
